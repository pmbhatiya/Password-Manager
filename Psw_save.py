import Psw_save_Init  # Defines all the functions used in password_keeper
...
def mainPasswordKeeper(username):
    ...
    def view():
        try:
            ...
            root.destroy()
            Psw_save_Init.show_all(key, username)
    ...
    def add():
        try:
            ...
            Psw_save_Init.createTable(username)
        ...
        try:
            ...
            add_new.iconbitmap("Static/PM.ico")
            width2 = 500
            height2 = 600
            ...
            def submit_add():
                ...
                encrypted_info = Cryptography_Init.encrypt_all(username, user_entry.get(), password_entry.get(), email_entry.get(), info_entry.get())

                # Gives the encrypted info to submit to the db (data base)
                Psw_save_Init.add_one(username, encrypted_info[0], encrypted_info[1], encrypted_info[2],
                                                     encrypted_info[3])
        ...
        try:
            ...
            def search():
                ...
                if (clicked.get()=="ID"):
                    ...
                    Psw_save_Init.id_lookup(key, username, search_entry.get())
                    print("If blank, none where found.")
                elif (clicked.get() == "Name"):
                    # Gets the key for the specified user
                    key = Cryptography_Init.get_key(username)
                    # Searches for a match in database
                    Psw_save_Init.name_lookup(key, username, search_entry.get())
                    print("If blank, none where found.")
                    pass
                    ...
                    key = Cryptography_Init.get_key(username)
                    # Searches for a match in database
                    Psw_save_Init.email_lookup(key, username, search_entry.get())
                    print("If blank, none where found.")
                    pass
                else:
    ...
    def edit():
        ...
        def edit_record():
            ...
            if id_entry.get() == "":
                ...
                edit_new.iconbitmap("Static/PM.ico")
                width3 = 500
                height3 = 600
                ...
                def edit_add():
                    # Encrypts all the info given by the user
                    encrypted_info = Cryptography_Init.encrypt_all(username, user_entry.get(), password_entry.get(),
                                                                     email_entry.get(), info_entry.get())

                    Psw_save_Init.update_one(username, encrypted_info[0], encrypted_info[1],
                                                        encrypted_info[2],
    ...
    def delete():
        ...
        delete_record.iconbitmap("Static/PM.ico")
        width2 = 350
        height2 = 300
        ...
        def delete_passwrd():
            try:
                if messagebox.askokcancel("Sure tho?", "Are you sure you want to delete this record?") == 1:
                    ...
                    print(username)
                    print(type(username))
                    Psw_save_Init.delete_one(username, id_var)
    ...
    def exit_program():
        ...
        my_img = ImageTk.PhotoImage(Image.open("Static/PM.png"))
